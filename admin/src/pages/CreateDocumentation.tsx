  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50">
        ...
        <div className="max-w-[1800px] mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            ...
            <button
              ...
              disabled={loading}
              className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 md:px-6 py-2 md:py-3 bg-green-200 border-3 border-black rounded-xl font-bold hover:bg-green-300 transition shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] disabled:opacity-50 text-sm md:text-base"
            >
      ...
      <div className="flex-1 flex flex-col lg:flex-row overflow-hidden">
        {/* Left Side - Form */}
        <div className="w-full lg:w-[400px] border-b-4 lg:border-b-0 lg:border-r-4 border-black bg-white p-4 md:p-6 overflow-y-auto">
                      ...
                      >
                        <div className="flex items-center gap-3 p-3">
                          ...
                          <button
                            ...
                            title="Delete asset"
                          >
                            <Trash2 className="w-6 h-6 text-gray-400 hover:text-red-600 transition" strokeWidth={2.5} />
                          </button>
                        </div>
                      </div>
                    ))}
