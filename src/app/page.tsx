...
export default function Home() {
  ...
  return (
    <div ref={containerRef} className="relative bg-[#050505] font-sans selection:bg-sky-500 selection:text-white text-white">
      ...
      {/* SECTION 1 - HERO */}
      <section className="sticky top-0 h-screen flex items-center justify-center p-2 md:p-3 overflow-hidden z-0">
        <motion.div
          className="relative w-full h-full rounded-2xl md:rounded-3xl overflow-hidden bg-[#030303]">

          {/* Grain Texture */}
          <div className="absolute inset-0 z-[2] opacity-[0.04] pointer-events-none" style={{ backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noiseFilter'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.65' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noiseFilter)'/%3E%3C/svg%3E")` }} />

          {/* Animated Background Mesh - Refined */}
          ...
          <motion.div
            ...
            className="absolute right-0 md:right-[5%] bottom-[35%] md:bottom-0 z-[4] h-[75%] md:h-[95%] pointer-events-none select-none opacity-50 md:opacity-95"
          >
            <motion.img
              animate={{ y: [0, -15, 0] }}
      ...
      {/* SECTION 2 - ABOUT ME */}
      <section className="sticky top-0 h-screen flex items-center justify-center p-2 md:p-3 overflow-hidden z-10 pointer-events-none">
        <motion.div
          className="relative w-full h-full rounded-2xl md:rounded-3xl overflow-y-auto md:overflow-hidden bg-[#0a0a0a] border border-white/5 shadow-2xl pointer-events-auto custom-scrollbar">
          ...
          <div className="relative z-10 flex flex-col lg:grid lg:grid-cols-2 h-full max-w-7xl mx-auto items-center gap-10 md:gap-20 p-6 md:p-20">
      ...
      {/* SECTION 4 - NOTABLE STREAMERS */}
      <section className="sticky top-0 h-screen flex items-center justify-center p-2 md:p-3 overflow-hidden z-30 pointer-events-none">
        <motion.div
          ...
          <div className="max-w-7xl mx-auto h-full flex flex-col">
            <SectionHeader icon={Crown} title="OUR STREAMERS" subtitle="Vibrant Community" dark={true} />
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 flex-1">
              {[1, 2, 3, 4, 5, 6, 7, 8].map((i) =>
                <div key={i} className="group relative bg-white rounded-2xl border border-zinc-200 overflow-hidden hover:border-sky-400/50 transition-all duration-500 shadow-xl h-fit">
      ...
      {/* SECTION 5 - SERVER STATS */}
      <section className="sticky top-0 h-screen flex items-center justify-center p-2 md:p-3 overflow-hidden z-40 pointer-events-none">
        <motion.div
              ...
              <div className="lg:col-span-5 space-y-6 md:space-y-8">
                ...
                <div className="grid grid-cols-2 gap-3 md:gap-4">
                  {[
                    ...
                    map((stat, i) =>
                      <div key={i} className="bg-zinc-800 border border-zinc-700 p-4 md:p-8 rounded-xl md:rounded-2xl hover:bg-zinc-700 transition-all cursor-crosshair group">
      ...
      <section className="sticky top-0 h-screen flex items-center justify-center p-2 md:p-3 overflow-hidden z-50 pointer-events-none">
        <motion.div
          ...
          <div className="max-w-7xl mx-auto h-full flex flex-col">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 flex-1">
              {[
                ...
                map((tier, i) =>
                  <div key={i} className={`relative p-6 md:p-8 rounded-2xl md:rounded-3xl border ${tier.border} ${tier.bg} flex flex-col items-center text-center group transition-all duration-500 hover:scale-[1.02] md:hover:scale-105 shadow-xl overflow-hidden h-fit`}>
                    ...
                    <ul className="space-y-2 md:space-y-4 mb-8 md:mb-12 flex-1">
                      {tier.features.map((f, j) =>
                        <li key={j} className="text-zinc-500 font-bold uppercase text-[8px] md:text-xs tracking-widest">{f}</li>
                      )}
                    </ul>
      ...
      {/* SECTION 7 - GALLERY / RECENT EVENTS */}
      <section className="sticky top-0 h-screen flex items-center justify-center p-2 md:p-3 overflow-hidden z-[60] pointer-events-none">
        <motion.div
          ...
          <div className="max-w-7xl mx-auto h-full flex flex-col">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4 flex-1 overflow-hidden">
              {[
                ...
                map((src, i) =>
                  <div key={i} className="relative rounded-xl md:rounded-2xl overflow-hidden border border-zinc-200 group cursor-pointer aspect-square">
      ...
      <section className="sticky top-0 h-screen flex items-center justify-center p-2 md:p-3 overflow-hidden z-[70] pointer-events-none">
        <motion.div
          ...
          <div className="max-w-7xl mx-auto h-full flex flex-col">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 flex-1">
              {[
                ...
                map((news, i) =>
                  <div key={i} className="group relative bg-zinc-50 border border-zinc-200 rounded-2xl overflow-hidden hover:border-sky-400 transition-all h-fit">
      ...
      <section className="sticky top-0 h-screen flex items-center justify-center p-2 md:p-3 overflow-hidden z-[80] pointer-events-none">
        <motion.div
          ...
          <div className="max-w-7xl mx-auto h-full flex flex-col">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 flex-1">
              {[
                ...
                map((step, i) =>
                  <div key={i} className="relative p-8 md:p-12 bg-zinc-50 border border-zinc-100 rounded-2xl md:rounded-3xl flex flex-col justify-between group hover:bg-zinc-100 transition-all h-fit min-h-[200px] md:min-h-[280px]">
      ...
      {/* SECTION 10 - MEDIA PARTNERS */}
      <section className="sticky top-0 h-screen flex items-center justify-center p-2 md:p-3 overflow-hidden z-[90] pointer-events-none">
        <motion.div
          className="relative w-full h-full rounded-2xl md:rounded-3xl overflow-y-auto bg-gradient-to-br from-white via-zinc-50 to-zinc-100 border border-zinc-200 shadow-2xl pointer-events-auto p-6 md:p-12 custom-scrollbar">
          ...
          <div className="max-w-7xl mx-auto h-full flex flex-col">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-8 md:gap-12 flex-1 items-center">
              {[
                ...
                <div key={index} className="grayscale opacity-40 hover:grayscale-0 hover:opacity-100 transition-all cursor-pointer flex justify-center items-center p-4">
      ...
      {/* SECTION 11 - LUXURY GARAGE (NEW) */}
      <section className="sticky top-0 h-screen flex items-center justify-center p-2 md:p-3 overflow-hidden z-[100] pointer-events-none">
        <motion.div
          className="relative w-full h-full rounded-2xl md:rounded-3xl overflow-y-auto bg-gradient-to-br from-sky-50 via-white to-blue-50 border border-sky-200 shadow-2xl pointer-events-auto p-6 md:p-12 custom-scrollbar">
      ...
      {/* SECTION 12 - CAREER PATHS (NEW) */}
      <section className="sticky top-0 h-screen flex items-center justify-center p-2 md:p-3 overflow-hidden z-[110] pointer-events-none">
        <motion.div
          className="relative w-full h-full rounded-2xl md:rounded-3xl overflow-y-auto bg-gradient-to-br from-zinc-900 via-black to-zinc-900 border border-zinc-800 shadow-2xl pointer-events-auto p-6 md:p-12 custom-scrollbar">
          ...
          <div className="max-w-7xl mx-auto h-full flex flex-col">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 flex-1">
              {[
                ...
                map((job, i) =>
                  <div key={i} className="relative rounded-xl md:rounded-2xl overflow-hidden border-2 border-zinc-200 group hover:border-sky-400 transition-all cursor-pointer aspect-square md:aspect-auto">
      ...
      {/* SECTION 13 - FACTION WARFARE (NEW) */}
      <section className="sticky top-0 h-screen flex items-center justify-center p-2 md:p-3 overflow-hidden z-[120] pointer-events-none">
        <motion.div
          className="relative w-full h-full rounded-2xl md:rounded-3xl overflow-y-auto bg-gradient-to-br from-white via-zinc-50 to-zinc-100 border border-zinc-200 shadow-2xl pointer-events-auto p-6 md:p-12 custom-scrollbar">
      ...
      {/* SECTION 14 - FOOTER / FINAL CTA */}
      <section className="sticky top-0 h-screen flex items-center justify-center p-2 md:p-3 overflow-hidden z-[130] pointer-events-none">
        <motion.div
